...
|--------|-------------|------|
| Pokedex App | Search Pokémon & view details | HTML, CSS, JS |
| Portfolio Website | Personal portfolio | HTML, CSS |
| Hotstar Clone | UI clone | HTML, CSS |
| Daily Coding | Logic practice | Java, JS |
